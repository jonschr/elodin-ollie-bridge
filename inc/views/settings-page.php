<div class="wrap elodin-bridge-admin">
	...
	<div class="elodin-bridge-admin__cards">
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="editor">
				<div class="elodin-bridge-admin__feature <?php echo $remove_ollie_color_palettes_enabled ? 'is-enabled' : ''; ?> <?php echo ! $ollie_pro_available ? 'is-unavailable' : ''; ?>">
		...
		<div class="elodin-bridge-admin__card" data-bridge-category="editor">
			<div class="elodin-bridge-admin__feature <?php echo $child_theme_gradient_duotone_autogen_enabled ? 'is-enabled' : ''; ?> <?php echo ! $ollie_pro_available ? 'is-unavailable' : ''; ?>">
				<label class="elodin-bridge-admin__feature-header" for="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_CHILD_THEME_GRADIENT_DUOTONE_AUTOGEN ); ?>">
					...
					<span class="elodin-bridge-admin__feature-title"><?php esc_html_e( 'Generate missing gradients and duotones', 'elodin-bridge' ); ?></span>
				</label>
				<div class="elodin-bridge-admin__feature-body">
					<p class="elodin-bridge-admin__description">
		...
		<div class="elodin-bridge-admin__card elodin-bridge-admin__card--wide" data-bridge-category="style">
			<div class="elodin-bridge-admin__feature <?php echo $scroll_hide_elements_enabled ? 'is-enabled' : ''; ?>">
				<label class="elodin-bridge-admin__feature-header" for="elodin-bridge-scroll-hide-elements-enabled">
					<input
						type="hidden"
						name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_SCROLL_HIDE_ELEMENTS ); ?>[enabled]"
						value="0"
					/>
					<input
						type="checkbox"
						class="elodin-bridge-admin__toggle-input elodin-bridge-admin__feature-toggle"
						id="elodin-bridge-scroll-hide-elements-enabled"
						name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_SCROLL_HIDE_ELEMENTS ); ?>[enabled]"
						value="1"
						<?php checked( $scroll_hide_elements_enabled ); ?>
					/>
					<span class="elodin-bridge-admin__toggle-track" aria-hidden="true">
						<span class="elodin-bridge-admin__toggle-thumb"></span>
					</span>
					<span class="elodin-bridge-admin__feature-title"><?php esc_html_e( 'Hide elements on scroll', 'elodin-bridge' ); ?></span>
				</label>
				<div class="elodin-bridge-admin__feature-body">
					<p class="elodin-bridge-admin__description">
					...
					<div
						...
						data-next-index="<?php echo esc_attr( (string) count( $scroll_hide_element_rows ) ); ?>"
					>
						<div class="elodin-bridge-admin__scroll-hide-rules">
								...
								<div class="elodin-bridge-admin__scroll-hide-row">
									<label class="elodin-bridge-admin__scroll-hide-field elodin-bridge-admin__scroll-hide-field--selectors">
										...
										<input
											...
											name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_SCROLL_HIDE_ELEMENTS ); ?>[rules][<?php echo esc_attr( (string) $index ); ?>][selectors]"
											value="<?php echo esc_attr( $rule['selectors'] ?? '' ); ?>"
											placeholder=".site-header"
										/>
									</label>
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="editor">
				<div class="elodin-bridge-admin__feature <?php echo $editor_list_view_default_enabled ? 'is-enabled' : ''; ?>">
					<label class="elodin-bridge-admin__feature-header" for="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_EDITOR_LIST_VIEW_DEFAULT ); ?>">
						<input
							type="hidden"
							name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_EDITOR_LIST_VIEW_DEFAULT ); ?>"
							value="0"
						/>
						<input
							type="checkbox"
							class="elodin-bridge-admin__toggle-input elodin-bridge-admin__feature-toggle"
							id="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_EDITOR_LIST_VIEW_DEFAULT ); ?>"
							name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_EDITOR_LIST_VIEW_DEFAULT ); ?>"
							value="1"
							<?php checked( $editor_list_view_default_enabled ); ?>
						/>
						<span class="elodin-bridge-admin__toggle-track" aria-hidden="true">
							<span class="elodin-bridge-admin__toggle-thumb"></span>
						</span>
						<span class="elodin-bridge-admin__feature-title"><?php esc_html_e( 'Default list view to open in the editor', 'elodin-bridge' ); ?></span>
					</label>

					<div class="elodin-bridge-admin__feature-body">
						<p class="elodin-bridge-admin__description">
							<?php esc_html_e( 'Opens list view when the block editor loads. Users can still close it while editing.', 'elodin-bridge' ); ?>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="editor">
				<div class="elodin-bridge-admin__feature <?php echo $editor_show_template_default_enabled ? 'is-enabled' : ''; ?> <?php echo ! $editor_show_template_default_available ? 'is-unavailable' : ''; ?>">
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="editor">
				<div class="elodin-bridge-admin__feature <?php echo $site_editor_admin_bar_enabled ? 'is-enabled' : ''; ?> <?php echo ! $site_editor_admin_bar_available ? 'is-unavailable' : ''; ?>">
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="misc">
				<div class="elodin-bridge-admin__feature <?php echo $direct_cover_video_urls_enabled ? 'is-enabled' : ''; ?>">
					<label class="elodin-bridge-admin__feature-header" for="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_DIRECT_COVER_VIDEO_URLS ); ?>">
						<input
							type="hidden"
							name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_DIRECT_COVER_VIDEO_URLS ); ?>"
							value="0"
						/>
						<input
							type="checkbox"
							class="elodin-bridge-admin__toggle-input elodin-bridge-admin__feature-toggle"
							id="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_DIRECT_COVER_VIDEO_URLS ); ?>"
							name="<?php echo esc_attr( ELODIN_BRIDGE_OPTION_ENABLE_DIRECT_COVER_VIDEO_URLS ); ?>"
							value="1"
							<?php checked( $direct_cover_video_urls_enabled ); ?>
						/>
						<span class="elodin-bridge-admin__toggle-track" aria-hidden="true">
							<span class="elodin-bridge-admin__toggle-thumb"></span>
						</span>
			...
			<div class="elodin-bridge-admin__card" data-bridge-category="misc">
				...
				<div class="elodin-bridge-admin__card" data-bridge-category="editor">
					<div class="elodin-bridge-admin__feature <?php echo $editor_group_border_enabled ? 'is-enabled' : ''; ?>">
